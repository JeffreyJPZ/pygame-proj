...
def main():
    ...
    def redraw_win():
        ...
        win.blit(display_score, (win_width / 3 + win_width / 3 - display_score.get_width() / 2, win_height - display_score.get_height() - 20)) # Score blitted after objects to prevent objects from covering the text
...
def instructions():
    ...
    while run:
        ...
        display_instructions2 = instructions_font.render(f'Car models by EdSquare at OpenGameArt.org', 1, (255,0,0))
